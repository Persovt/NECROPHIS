...
namespace ImGui
{
	...
	IMGUI_API ImVec2		GetWindowPos2(); // get current window position in screen space (useful if you want to do your own drawing via the DrawList api)
...
struct ImGuiStorage
{
	...
	IMGUI_API bool          SliderBehavior(const char* label, float* v, float v_min, float v_max, const char* display_format = "%.3f", float power = 1.0f);
...
struct ImDrawList
{
	...
	IMGUI_API void	AddCornerBox(const ImVec2& pos, ImU32 col, float thickness, const int height, const int width);

	IMGUI_API void	AddBox(const ImVec2& pos, ImU32 col, float thickness, const int height, const int width);
	IMGUI_API void  AddSkeleton(const ImVec2& pos, ImU32 col, float thickness);
	IMGUI_API void	AddHealthBar(const ImVec2& pos, ImU32 col, float thickness, const int width);
	IMGUI_API void	AddHealthBar2(const ImVec2& pos, ImU32 col, float thickness, const int size);
	IMGUI_API void	AddHealthBar3(const ImVec2& pos, ImU32 col, float thickness, const int size);
